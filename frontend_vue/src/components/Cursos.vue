                            ...
                            <div :key="i" class="card--content">
                                <v-hover v-slot:default="{ hover }" style="margin-bottom:10px;">
                                    <v-card :elevation="hover ? 12 : 2" width="280px" :class="{ 'on-hover': hover }" color="botonRepro">
                                        ...
                                        <v-card-actions>
                                            <v-btn class="ma-2 mx-auto" rounded outlined color="white" href="/clases#/login" style="padding-left:20px; padding-right:20px;" :to="item.url">Comenzar</v-btn>
                                        </v-card-actions>     
                                    </v-card>
                                </v-hover>
                            </div>
                            ...
                            <v-col :key="i" cols="12" md="3">
                                <v-hover v-slot:default="{ hover }" style="margin-bottom:10px;">
                                    <v-card :elevation="hover ? 12 : 2" :class="{ 'on-hover': hover }" >
                                        ...
                                        <v-card-actions>
                                            <v-btn class="ma-2 mx-auto" rounded outlined color="indigo" href="/clases#/login" style="padding-left:20px; padding-right:20px;">Comenzar</v-btn>
                                        </v-card-actions>     
                                    </v-card>
                                </v-hover>
                            </v-col>
