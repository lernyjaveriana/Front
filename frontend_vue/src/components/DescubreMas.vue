<template>
				...
				<v-row style="width:100%;padding-left:10%;padding-right:10%;">
					<v-col cols="12" sm="9">
						...
						<div style="width:170px;"> 
							<v-btn rounded block color="boton_menu" href="/clases#/login" style="margin-top:30px;" dark>Comenzar</v-btn>
						</div>
					</v-col>
				</v-row>
			</div>
	...
	<!-- Informacion Rutas, Podcast Educativos, Nuestros contenidos---------------------------------------------- -->
